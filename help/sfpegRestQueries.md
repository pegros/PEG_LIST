...
It relies on the standard **[http](https://developer.salesforce.com/docs/atlas.en-us.apexref.meta/apexref/apex_classes_restful_http_http.htm)** Apex classe to managed REST callouts.

This class comes with its **sfpegRestQueries_TST** test class.
